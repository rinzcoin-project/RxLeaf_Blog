...
class WPUF_Form_Builder_Field_Settings_Pro extends WPUF_Form_Builder_Field_Settings {
    ...
    public static function file_upload() {
        ...
        if ( is_wpuf_post_form_builder() ) {
            ...
            $settings[] = array(
                ...
                'title'     => __( 'Visibility', 'wpuf-pro' ),
                'type'      => 'visibility',
                'section'   => 'advanced',
                'options'   => array(
                    'everyone'          => __( 'Everyone', 'wpuf-pro' ),
                    'hidden'            => __( 'Hidden', 'wpuf-pro' ),
                    'logged_in'         => __( 'Logged in users only', 'wpuf-pro' ),
                    'subscribed_users'  => __( 'Subscription users only', 'wpuf-pro' ),
                ),
                'priority'  => 30,
                'inline'    => true,
                'help_text' => __( 'Select option', 'wpuf-pro' ),
            );
    ...
    public static function embed() {
        ...
        return array(
            'template'      => 'embed',
            'title'         => __( 'Embed', 'wpuf-pro' ),
            'icon'          => 'play-circle',
            'settings'      => $settings,
            'field_props'   => array(
                'input_type'        => 'url',
                'template'          => 'embed',
                'label'             => __( 'Embed', 'wpuf-pro' ),
                'name'              => '',
                'is_meta'           => 'yes',
                'help'              => '',
                'required'          => 'no',
