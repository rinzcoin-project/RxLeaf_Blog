 ...
 */
?>
<div class="registration" id="wpuf-registration-form-not">
    ...
    if ( isset($_GET['success']) && "yes" == $_GET['success'] ) {
        echo "<div class='wpuf-success' style='text-align:center'>" . __( 'To complete your registration please login', 'wp-user-frontend' ) ."</div>";
    }
    ?>
